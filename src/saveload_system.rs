...
pub fn save_game(ecs: &mut World) {
		...
		.build();
	{
		...
		serialize_individually!(ecs, serializer, data, Position, Renderable, Player, Viewshed, Monster, Name, BlocksTile, CombatStats, SufferDamage, 
			...
			EntityMoved, EntryTrigger, Hidden, SingleActivation, ParticleLifetime, Door, BlocksVisibility
		);
...
pub fn load_game(ecs: &mut World) {
...

	{
		...
		deserialize_individually!(ecs, de, d, Position, Renderable, Player, Viewshed, Monster, 
			...
			MagicMapper, EntityMoved, EntryTrigger, Hidden, SingleActivation, ParticleLifetime, Door, BlocksVisibility
		);
	}

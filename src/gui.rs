...
use super::{CombatStats, Player, GameLog, Map, Name, Position, State, InBackpack, Viewshed, RunState, Equipped, Hidden, get_screen_bounds};
...
pub enum GameOverResult { NoSeleciton, QuitToMenu }

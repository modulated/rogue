...
use super::{
    ...
    InflictsDamage, MagicMapper, Map, Name, ParticleBuilder, Position, ProvidesHealing, RunState,
        ...
        for (entity, useitem) in (&entities, &wants_use).join() {
            ...
            for mob in add_confusion.iter() {
                confused
                    ...
                    .expect("Unable to apply confusion");
            }
